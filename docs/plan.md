...
**DONE:** U01–U20, U21b.  **REMAINING:** U21 polish, backend U22–U24, native U25–U27.

**Next wave:** U21 polish pass — cross-cutting (touches ~every screen), so NOT parallelizable; do solo, last. It is the final Windows-buildable unit. After it, U22–U24 need a deployed server and U25–U27 need a Mac — both blocked on infra unavailable in this environment.
